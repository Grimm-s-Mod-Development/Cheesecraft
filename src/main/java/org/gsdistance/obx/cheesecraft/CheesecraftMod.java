...
@Mod("cheesecraft")
public class CheesecraftMod {
	public static final Logger LOGGER = LogManager.getLogger(CheesecraftMod.class);
	public static final String MODID = "cheesecraft";

	public CheesecraftMod(IEventBus modEventBus) {
